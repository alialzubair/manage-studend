...
JOIN hulls on  hulls.Hulls_id=appointment.hull_id where appointment.status=0";
         ...
         <div class="table-responsive">
           <table class="table table-hover table-striped">
            ...
            <tr>
                ...
                <td>
                <a href="?do=approve&id=<?php echo $r['Appointment_id'] ?>" class="btn btn-info">Approve</a>
